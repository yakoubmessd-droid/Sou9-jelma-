...
def init_db():
    ...
    if not admin:
        conn.execute("""
            INSERT INTO users
            (username, password, phone, email, is_admin)
            VALUES (?, ?, ?, ?, ?)
        """, (
            "so9na.com",
    ...
    return render_template_string(
        ...
        <div class="container">
            ...
            <div class="form-box">
                ...
                <p>
                    📧 الإيميل:
                    <b>{{ user['email'] or 'غير موجود' }}</b>
                </p>

                <p>
                    📱 رقم الهاتف:
                    <b>{{ user['phone'] or 'غير موجود' }}</b>
                </p>
                ...
                <div class="user-admin-card">
                    ...
                    {% if user['username'] != 'so9na.com' %}
                        ...
                        <a
                            ...
                            onclick="
                                return confirm(
                                    '⚠️ متأكد تحب تحذف الحساب؟ سيتم حذف إعلاناته ورسائله.'
                                );
                            "
                        >
                            🗑️ حذف الحساب
